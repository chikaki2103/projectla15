    ...
    <div class="login-box-body">
        ...
        <form method="POST" action="/admin/login">
            ...
            <div class="form-group has-feedback">
                ...
                <input id="username" type="text" placeholder="Username or email" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus>
